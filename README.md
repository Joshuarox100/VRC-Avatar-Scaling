...
>\* \- Reference Animations must be 3 frames long and contain curves for Local Scale.<br>(You can create a compatible reference by creating and modifying a duplicate of "Size Settings (ASTemplate)".)
