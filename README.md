...
>\* \- Reference Animations must be 3 frames long and contain curves for Local Scale.<br>(You can duplicate "Size Settings (ASTemplate)" and modify it to ensure it's compatible.)
