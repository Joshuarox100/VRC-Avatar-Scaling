...
0) Download and import the latest **Unity Package** from the [**Releases**](https://github.com/Joshuarox100/VRC-Avatar-Scaling/releases) section on GitHub **(You will have issues if you don't)**.
